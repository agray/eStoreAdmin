<%@ Page Title="Online Users" Language="C#" MasterPageFile="~/MasterPages/eStoreAdminMaster.Master" AutoEventWireup="true" CodeBehind="OnlineUsers.aspx.cs" Inherits="eStoreAdminWeb.Web.Advanced.Users.OnlineUsers" %>
        ...
        <tr>
            <td valign="top">
                ...
                <asp:GridView ID="Users" runat="server" 
                    ...
                    <EmptyDataTemplate>
                        There are no online users currently.
                    </EmptyDataTemplate>
                </asp:GridView>
            </td>
        </tr>
